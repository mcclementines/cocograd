...
int main()
{
    struct Value *x1 = init_value(2.0);
    struct Value *x2 = init_value(0.0);

    struct Value *w1 = init_value(-3.0);
    struct Value *w2 = init_value(1.0);

    struct Value *b = init_value(6.8813735870195432);
